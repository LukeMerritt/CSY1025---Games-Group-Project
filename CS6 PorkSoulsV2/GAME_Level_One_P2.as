package  
{
	...
	public class GAME_Level_One_P2 extends SCRIPT_Scene_Class{
		
		
		public function GAME_Level_One_P2() {
			
			trace("GAME_Level_One_P2 constructor");
		...
		override public function OnLeaveScene()	{
			...
			trace("leaving GAME_Level_One_P2 scene");
